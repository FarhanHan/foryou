...
footer.href = "https://www.instagram.com/beo.krypton/";

document.querySelector(".tombol").addEventListener('click', function () {
  Swal.fire("Hallo Sayangku Ziya", "Aku ada pertanyaan nih buat kamu?", "question").then(function () {
      ...
      Swal.fire("Awas aja kalo boong!!", "", "error").then(function () {
        ...
        const {
          ...
          const pertanyaan = Swal.fire({
            title: `Ziya sayang ga sama ${sender}?`,
            showDenyButton: true,
            showCancelButton: false,
            ...
            if (result.isConfirmed) {
              Swal.fire(`Aku juga sayang banget sama Ziya`).then(function () {
                Swal.fire({
                  ...
                  Swal.fire(`Makasih ya udah sayang sama ${sender} ${val}%`).then(function () {
                    Swal.fire({
                      title: `Sekarang Ziya kangen ga sama ${sender}?`,
                      showDenyButton: true,
                      showCancelButton: false,
                      ...
                      /* Read more about isConfirmed, isDenied below */
                      if (result.isConfirmed) {
                        Swal.fire(`Huhu iya aku juga kangen Ziya :((`).then(function () {
